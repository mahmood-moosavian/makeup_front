    ...
    <div class="sm:max-w-sm flex flex-col sm:border rounded-sm mx-auto mt-6 p-5">
      ...
      <div class="flex items-center justify-center mt-5 mb-3 h-10 pb-3 text-cyan_darkeset_200">
        <input
          ...
          name="num4"
          maxlength="1"
          class="w-12 mx-2 text-center border-b-2 focus:outline-none focus:border-gray-400"
          autocomplete="off"
        />
        <input
          ref="num3"
...
export default {
  ...
  watch: {
    num1() {
      if (this.num1.length > 0) this.$refs.num2.focus();
      else this.$refs.num1.focus();
    },
    num2() {
      if (this.num2.length > 0) this.$refs.num3.focus();
      else this.$refs.num1.focus();
    },
    num3() {
      if (this.num3.length > 0) this.$refs.num4.focus();
